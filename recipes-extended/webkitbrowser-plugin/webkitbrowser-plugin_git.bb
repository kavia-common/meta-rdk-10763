...
EXTRA_OECMAKE += " \
    ...
    -DPLUGIN_WEBKITBROWSER_MEMORYPRESSURE_WEBPROCESSLIMIT="${WEBKITBROWSER_MEMORYPRESSURE_WEBPROCESSLIMIT}" \
    -DPLUGIN_WEBKITBROWSER_MEMORYPRESSURE_NETWORKPROCESSLIMIT="${WEBKITBROWSER_MEMORYPRESSURE_NETWORKPROCESSLIMIT}" \
    ...
    -DPLUGIN_SEARCH_AND_DISCOVERY_APP_MEMORYPRESSURE_WEBPROCESSLIMIT="${SEARCH_AND_DISCOVERY_APP_MEMORYPRESSURE_WEBPROCESSLIMIT}" \
    -DPLUGIN_RESIDENT_APP_MEMORYPRESSURE_WEBPROCESSLIMIT="${RESIDENT_APP_MEMORYPRESSURE_WEBPROCESSLIMIT}" \
    -DPLUGIN_HTML_APP_MEMORYPRESSURE_WEBPROCESSLIMIT="${HTML_APP_MEMORYPRESSURE_WEBPROCESSLIMIT}" \
    -DPLUGIN_LIGHTNING_APP_MEMORYPRESSURE_WEBPROCESSLIMIT="${LIGHTNING_APP_MEMORYPRESSURE_WEBPROCESSLIMIT}" \
    -DPLUGIN_HTML_APP_COMPOSITOR="${HTML_APP_COMPOSITOR}" \
    -DPLUGIN_LIGHTNING_APP_COMPOSITOR="${LIGHTNING_APP_COMPOSITOR}" \
    -DPLUGIN_JSPP_MEMORYPRESSURE_WEBPROCESSLIMIT="${JSPP_MEMORYPRESSURE_WEBPROCESSLIMIT}" \
